...
\[ \text { Area of overlap } = \lVert(min(t_2,t_4) - max(t_1,t_3))\rVert  \]
\[ \text { Area of union } = \lVert(max(t_2,t_4) - min(t_1,t_3))\rVert  \]
...
\[ \text { Area of overlap } = \lVert(min(x_2,x_4) - max(x_1,x_3),min(y_2,y_4) -  max(y_1,y_3), min(z_2,z_4) -  max(z_1,z_3) ) \rVert \]
\[ \text { Area of union } = \lVert(max(x_2,x_4) - min(x_1,x_3), max(y_2,y_4) - min(y_1,y_3), max(z_2,z_4) - min(z_1,z_3)  \]
