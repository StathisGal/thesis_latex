...
to reduce the sample duration. On top of that, we trained our network for sample duration = 8 and 4 frames. % We expect to get
% better results because, now we will deal with less frames, which means smaller number of
