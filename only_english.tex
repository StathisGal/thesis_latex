\documentclass[10pt, twoside, a4paper]{cvsp-thesis-eng}
...
\title{Human Action Recognition and Localization in videos}

\author{Efstathios E. Galanakis}
\supervisor{Petros Maragkos}
\epitropiF{Konstantinos Tzafestas}
\epitropiS{Haralambos Psilakis}
