...
\begin{figure}[h]
  \begin{subfigure}{1\textwidth}
    \centering
    \includegraphics[scale=0.25]{proposals0_half}
  ...
  \begin{subfigure}{1\textwidth}
    \centering
    \includegraphics[scale=0.25]{proposals1_half}
  ...
  \begin{subfigure}{1\textwidth}
    \centering
    \includegraphics[scale=0.25]{proposals2_half}
...
\begin{figure}[h]
  \begin{subfigure}{1\textwidth}
    \centering
    \includegraphics[scale=0.25]{proposal_gt}
    \caption{}
  ...
  \begin{subfigure}{1\textwidth}
    \centering
    \includegraphics[scale=0.25]{proposal_gt1}
    \caption{}
